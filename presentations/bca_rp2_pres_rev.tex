...
\begin{document}
  ...
  \begin{frame}
    ...
    \end{itemize}
    \linebreak
    \small{Power to detect $\hat\delta_{\rho}$ in MZ and DZ twins $\sim \mathcal{N}\bigg(\left[\begin{smallmatrix}0\\ 0\end{smallmatrix}\right],\, \left[\begin{smallmatrix}1 & {\rho} \\ {\rho} & 1\end{smallmatrix}\right] \bigg)$}
    \begin{center}
      \begin{figure}[!htb]
        \minipage{0.49\textwidth}
