...
\begin{document}
  ...
  \begin{frame}
    ...
    \item Generalized Variable Test (GVT) \footfullcite{Krishnamoorthy2014,KazemiJafari2016}
    \item Signed log-likelihood ratio test \footfullcite{DiCiccio2001,KazemiJafari2016}  
