...
% to create a note \todo{rephrase sentence}  or
			...
			% \todo[inline]{From Fransisca et al. Comparison of rapid diagnostic test Plasmotec Malaria-3, microscopy, and quantitative real-time PCR for diagnoses of \plf and \plv infections in Mimika Regency, Papua, Indonesia. Malaria journal. 2015;14:103: "standard expert microscopy should continue to be used as the reference gold standard for malaria diagnosis despite the \emph{likelihood of missing some low density parasitemia and sub-microscopic infections}." }
