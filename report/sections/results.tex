...
\begin{figure}[htb]
  ...
  \minipage{0.33\textwidth}% 
    ...
    % \label{fig:3}
  \endminipage\hfill
  \caption{Left to right, above: Sample size estimates to achieve 80\% power using (a) 100, (b) 1,000, and (c) 10,000 simulation for bivariate normal distributions with respective $\rho$ of 0.2 and 0.5.}
  ...
  \minipage{0.33\textwidth}% 
    ...
    % \label{fig:6}
  \endminipage\hfill
  \caption{Left to right, above: Sample size estimates to achieve 80\% power using (a) 100, (b) 1,000, and (c) 10,000 simulation for bivariate "mild skew" gamma distributions with respective $\rho$ of 0.2 and 0.5.}
  ...
  \endminipage\hfill
  \caption{Left to right, above: Sample size estimates to achieve 80\% power using (a) 100, (b) 1,000, and (c) 10,000 simulation for bivariate "extreme skew" gamma distributions with respective $\rho$ of 0.2 and 0.5.}
